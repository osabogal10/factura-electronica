...
//GET by Id
router.get('/:idFactura', checkAuth, (req, res, next) => {
...
//UPDATE factura
router.patch('/:idFactura', checkAuth, (req, res, next) => {
...
//DELETE factura 
router.delete('/:idFactura', checkAuth, (req, res, next) => {
  let idFactura = req.params.idFactura;
...
//GET everything 
router.get('/:idFactura/Todo', checkAuth, (req, res, next) => {
  const idFactura = req.params.idFactura;
