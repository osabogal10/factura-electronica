    ...
    return this.state.productos.map((prod, i) => 
      <div key={'form-group' +i} className="form-group row">
        ...
        <div className={'col centrarContenido'}>
          <input key={'inputProd' +i} type="number" className="form-control inputNumber" name={prod._id} placeholder="0" onChange={this.handleQuantityChange}/>
        </div>
      </div>
            ...
            <div className="main-div">
              <form id="Signup" onSubmit ={this.handleSubmit}>
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" id="inputNombre" placeholder="Nombre" onChange={this.handleClientNameChange}/>
                </div>
                <div className="form-group">
                  <p className="labelInput">Ingresa la cédula del cliente:</p>
                  <input type="number" className="form-control" id="inputDescripcion" placeholder="Cédula" min="1" onChange={this.handleCedulaClienteChange}/>
                </div>
                <div className="form-group">
                  <p className="labelInput">Ingresa la fecha de la compra:</p>
                  <input type="text" className="form-control" id="inputPrecio" placeholder="Fecha" onChange={this.handleDateChange}/>
                </div>
                <br/>
